...
const NX_COMPOSE_DIRECTIONS = {
  'editorial-minimal': {
    ...
    type: { family: "'Playfair Display', Georgia, serif", bodyFamily: "'Söhne', 'Inter', system-ui, sans-serif", display: 'clamp(3.2rem,8.5vw,6.6rem)', hero: 'clamp(2.6rem,6vw,4.6rem)', section: 'clamp(1.7rem,3.4vw,2.6rem)', body: 'clamp(1.02rem,1.35vw,1.14rem)', caption: '0.78rem', btn: '0.74rem', measure: '62ch' },
  ...
  'cinematic-immersive': {
    ...
    type: { family: "'Space Grotesk', 'Inter', sans-serif", bodyFamily: "'Inter', system-ui, sans-serif", display: 'clamp(3.4rem,10vw,8rem)', hero: 'clamp(2.4rem,6vw,4.8rem)', section: 'clamp(1.9rem,4vw,3.1rem)', body: 'clamp(1.05rem,1.4vw,1.2rem)', caption: '0.8rem', btn: '0.75rem', measure: '58ch' },
  ...
  'luxury-art': {
    ...
    type: { family: "'Playfair Display', 'Didot', Georgia, serif", bodyFamily: "'Söhne', 'Inter', system-ui, sans-serif", display: 'clamp(3rem,7.5vw,5.8rem)', hero: 'clamp(2.3rem,5.4vw,4.2rem)', section: 'clamp(1.6rem,3vw,2.3rem)', body: 'clamp(1.02rem,1.3vw,1.12rem)', caption: '0.72rem', btn: '0.72rem', measure: '56ch' },
  ...
  'bold-experimental': {
    ...
    type: { family: "'Archivo Black', 'Space Grotesk', sans-serif", bodyFamily: "'Space Grotesk', 'Inter', system-ui, sans-serif", display: 'clamp(4rem,13vw,10rem)', hero: 'clamp(3rem,9vw,7rem)', section: 'clamp(2.2rem,5.5vw,4rem)', body: 'clamp(1.05rem,1.4vw,1.2rem)', caption: '0.78rem', btn: '0.78rem', measure: '54ch' },
  ...
  'swiss-structured': {
    ...
    type: { family: "'Söhne', 'Neue Haas Grotesk Display', 'Helvetica Neue', Helvetica, sans-serif", bodyFamily: "'Inter', system-ui, sans-serif", display: 'clamp(3rem,8vw,5.6rem)', hero: 'clamp(2.2rem,4.8vw,3.6rem)', section: 'clamp(1.5rem,2.8vw,2.1rem)', body: 'clamp(1rem,1.25vw,1.08rem)', caption: '0.75rem', btn: '0.74rem', measure: '72ch' },
    radius: 0, shadow: 'none', surfaceFx: 'none',
