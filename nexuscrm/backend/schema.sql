...
CREATE TABLE IF NOT EXISTS sites (
  ...
  html TEXT DEFAULT '',
  graph TEXT DEFAULT '',                        -- canonical IR/Project Graph (JSON); HTML is a compiled projection
...
CREATE TABLE IF NOT EXISTS site_versions (      -- V7 version-control checkpoints (graph-native)
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  site_id INTEGER NOT NULL,
  label TEXT DEFAULT 'checkpoint',
  html TEXT DEFAULT '',
  graph TEXT DEFAULT '',                        -- the complete IR/Project Graph at checkpoint time (authoritative)
